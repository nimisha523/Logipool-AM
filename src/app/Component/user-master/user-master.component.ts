...
export class UserMasterComponent implements OnInit{
  ...
  constructor(private _dialog:MatDialog,private usermasterService:UserMasterService,private coreService:CoreService,private fb :FormBuilder,private cd:ChangeDetectorRef){}
  ...
  deleteUser(id: number) {
    this.usermasterService.deleteUser(id).subscribe({
      next: (res) => {
        this.getUserList();
      },
      error: (err) => {
        console.log(err);
        this.coreService.openSnackBar("Can't delete user as this user alocated to batches..", 'OK');
      }
    });
  }
